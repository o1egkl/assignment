...
if (fopen("https://".HTTP_REMOTE_SERVER_HOST."/LP/".$file_name.'.lp','r')){
	$html = file_get_contents ("https://".HTTP_REMOTE_SERVER_HOST."/LP/".$file_name.'.lp');
	if (!$html) {
	    echo "<p>Unable to open remote file."."https://".HTTP_REMOTE_SERVER_HOST."/LP/".$file_name.'.lp'.'</p>";
	    die();
	}else{
		echo $html;
	}
